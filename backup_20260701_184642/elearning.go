...
func elChatMessages(w http.ResponseWriter, r *http.Request) {
	...
	for rows.Next() {
		var id int
		var username, message, createdAt string
		var imagePath *string
		rows.Scan(&id, &username, &message, &createdAt, &imagePath)
		m := chatMsgOut{ID: id, Username: username, Message: message, CreatedAt: createdAt}
